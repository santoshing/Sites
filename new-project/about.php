        ...
        <div class="row  ">
            <div class="col-lg-7  d-flex">
                <div class="col-sm-6 pe-xl-5  ">
                    <img src="https://mizzle.webestica.com/assets/images/about/02.jpg" class="img-fluid"
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-6  mb-4 mb-sm-0">
                            <div class="bg-primary rounded text-center p-3">
                                ...
                                <p class="mb-0 text-white">Happy <br /> customers</p>
                            </div>
                        </div>
                    </div>

                    <!-- About image -->
                    <img src="https://mizzle.webestica.com/assets/images/about/01.jpg" class="img-fluid"
                        alt="about-img-2">
                </div>
            </div>
            ...
            <div class="col-lg-5">
                <span class=" px-3 py-2">🤝 Your gateway to digital
                    success</span>
                <h2 class="my-4">Defining the future <br>of online <br> experiences!</h2>
