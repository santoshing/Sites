                        ...
                        <div class="col-sm-6">
                            <div class="d-flex justify-content-between mb-4 mb-sm-0">
                                <div>
                                    ...
                                    <p class="mb-0">The all-in-one solution for businesses that want to succeed online.
                                    </p>
                                </div>
                                <!-- Divider line -->
                        ...
                        <div class="col-sm-6 ps-md-5">
                            ...
                            <ul class="list-group list-group-borderless mb-3 mb-sm-4">
                                <li class="list-group-item heading-color mb-0"><i
                                        class="bi bi-check-lg text-primary me-1"></i>Up to 05 users monthly</li>
                                <li class="list-group-item heading-color mb-0"><i
                                        class="bi bi-check-lg text-primary me-1"></i>Free 5 host &amp; domain</li>
                                <li class="list-group-item heading-color mb-0"><i
                                ...
                                <li class="list-group-item heading-color mb-0"><i
                                        class="bi bi-check-lg text-primary me-1"></i>Landing pages &amp; Web widgets
                                </li>
                                <li class="list-group-item heading-color mb-0"><i
                                        class="bi bi-check-lg text-primary me-1"></i>24/7 Dedicated Support</li>
                            </ul>
                            <!-- Button -->
